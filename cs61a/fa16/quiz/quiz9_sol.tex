...
\hline
\lstinline$b = baz(7)$ & \solution{\begin{tabular}{M{2.5cm}} \rule{0pt}{4.9ex} \\ \tt Nothing\end{tabular}} \\ [8ex]
\hline
...
\hline
\lstinline$print([x for x in b])$ & \solution{\begin{tabular}{M{2.5cm}} \\ \tt c \\ \tt b \\ \tt c \\ \tt b \\ \tt c \\ \tt b \\ \tt c \\ \tt [3, 6, 6] \\ \\\end{tabular}} \\ [8ex]
\hline
\end{tabular}
